...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='greet',
  syntax='proto3',
  serialized_options=b'\252\002\017GrpcTestService',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x0bgreet.proto\x12\x05greet\"\x1c\n\x0cHelloRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\"\x1d\n\nHelloReply\x12\x0f\n\x07message\x18\x01 \x01(\t2v\n\x07Greeter\x12\x32\n\x08SayHello\x12\x13.greet.HelloRequest\x1a\x11.greet.HelloReply\x12\x37\n\rSayHelloAgain\x12\x13.greet.HelloRequest\x1a\x11.greet.HelloReplyB\x12\xaa\x02\x0fGrpcTestServiceb\x06proto3'
)
...
_GREETER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SayHelloAgain',
    full_name='greet.Greeter.SayHelloAgain',
    index=1,
    containing_service=None,
    input_type=_HELLOREQUEST,
    output_type=_HELLOREPLY,
